...
const translations = {
    ...
    uz: {
        start: 'Boshlash',
        back: 'Ortga',
        bet_title: 'Tikish summasini kiriting',
        bet_amount: 'Tikish summasi:',
        confirm: 'TASDIQLASH',
        sync_title: "Ma'lumotlarni sinxronlash",
        extracting_handshake: 'Handsheykni ajratish...',
        establishing_connection: "Ulanish o'rnatilmoqda...",
        checking_strategy: 'Savdo strategiyasini tekshirish...',
        validating_session: 'Sessiya tasdiqlanmoqda...',
        analyzing_patterns: "Uchish naqshlari tahlili...",
        calculating_trajectory: 'Traektoriyani hisoblash...',
        analysis: "Uchish ma'lumotlari tahlili...",
        result_title: 'Tahlil natijasi',
        result_text: "Tahlilga ko'ra:<br><br><span class=\"result-highlight\">{bets}</span> ta tikish <span class=\"result-highlight\">{amount}₽</span> bilan, <span class=\"result-highlight\">X{multiplier}</span> g'alaba ehtimoli <span class=\"result-highlight\">{chance}%</span>",
        restart: 'Qayta boshlash',
        close: 'Yopish',
        data_points: "Ma'lumot nuqtalari:",
        accuracy: 'Prognoz aniqligi:'
    },
    hi: {
        start: 'प्रारंभ',
        back: 'वापस',
        bet_title: 'दांव राशि दर्ज करें',
        bet_amount: 'दांव राशि:',
        confirm: 'पुष्टि करें',
        sync_title: 'डेटा सिंक्रोनाइज़ेशन',
        extracting_handshake: 'हैंडशेक निकालना...',
        establishing_connection: 'कनेक्शन स्थापित करना...',
        checking_strategy: 'ट्रेडिंग रणनीति की जाँच...',
        validating_session: 'सत्र सत्यापन...',
        analyzing_patterns: 'उड़ान पैटर्न का विश्लेषण...',
        calculating_trajectory: 'पथ की गणना...',
        analysis: 'उड़ान डेटा का विश्लेषण...',
        result_title: 'विश्लेषण परिणाम',
        result_text: 'उड़ान डेटा विश्लेषण के आधार पर:<br><br>आपके पास <span class="result-highlight">{bets}</span> दांव बचे हैं, दांव <span class="result-highlight">{amount}₽</span> तक, <span class="result-highlight">X{multiplier}</span> जीत की संभावना <span class="result-highlight">{chance}%</span>',
        restart: 'फिर से शुरू करें',
        close: 'बंद करें',
        data_points: 'डेटा पॉइंट्स:',
        accuracy: 'पूर्वानुमान सटीकता:'
    },
    az: {
        start: 'BAŞLA',
        back: 'Geri',
        bet_title: 'Mərcləmə məbləğini daxil edin',
        bet_amount: 'Mərcləmə məbləği:',
        confirm: 'TƏSDİQLƏ',
        sync_title: 'Məlumatların sinxronizasiyası',
        extracting_handshake: 'Handşeyk çıxarılır...',
        establishing_connection: 'Bağlantı qurulur...',
        checking_strategy: 'Ticarət strategiyası yoxlanılır...',
        validating_session: 'Sessiya təsdiqlənir...',
        analyzing_patterns: 'Uçuş nümunələri analiz olunur...',
        calculating_trajectory: 'Trajektoriya hesablanır...',
        analysis: 'Uçuş məlumatlarının analizi...',
        result_title: 'Analizin nəticəsi',
        result_text: 'Uçuş məlumatlarının analizinə əsasən:<br><br><span class="result-highlight">{bets}</span> mərclər <span class="result-highlight">{amount}₽</span> məbləği ilə qalıb, <span class="result-highlight">X{multiplier}</span> qalibiyyət ehtimalı <span class="result-highlight">{chance}%</span>',
        restart: 'YENİDƏN BAŞLA',
        close: 'BAĞLA',
        data_points: 'Məlumat nöqtələri:',
        accuracy: 'Proqnoz dəqiqliyi:'
    }
};

// Текущий язык
let currentLang = 'ru';
// Определение начального языка из URL или localStorage
function getInitialLanguage() {
    const params = new URLSearchParams(window.location.search);
    const urlLang = params.get('language');
    const storedLang = localStorage.getItem('language');
    const lang = urlLang || storedLang || 'ru';
    return ['ru','en','uz','hi','az'].includes(lang) ? lang : 'ru';
}
let userBetAmount = 0;
...
function initializeApp() {
    // Установить язык из URL или localStorage до инициализации UI
...
function updateLanguageDisplay() {
    ...
    switch (currentLang) {
        ...
        case 'uz':
            currentFlag.innerHTML = `
                <rect width="32" height="8" fill="#1EB4E9"/>
                <rect width="32" height="8" y="8" fill="#ffffff"/>
                <rect width="32" height="8" y="16" fill="#1DBF73"/>
            `;
            currentLangSpan.textContent = 'UZ';
            break;
        case 'hi':
            currentFlag.innerHTML = `
        ...
        case 'az':
            currentFlag.innerHTML = `
                <rect width="32" height="8" fill="#3F9CFF"/>
                <rect width="32" height="8" y="8" fill="#FF0000"/>
                <rect width="32" height="8" y="16" fill="#00A550"/>
            `;
            currentLangSpan.textContent = 'AZ';
            break;
        default:
